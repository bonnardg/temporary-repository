...
Implémentation
--------------
L'algorithme optimisé est implémenté par la classe SmartRobot et sa méthode packItems() prenant en paramètre la liste des articles à positionner dans les cartons et retournant les cartons créés par le robot.

Vérification
------------
Voir les tests unitaires et plus particulièrement la classe SmartRobotTest.
